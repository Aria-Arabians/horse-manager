		...
		foreach ( $this->_meta_box['fields'] as $field ) {
            ...
            case 'posttype_select':
				...
				case 'file':
					...
					echo '<input class="cmb_upload_button button" type="button" value="'.__('Upload File','wp_horse').'" />';
					...
					echo '<div id="', $field['id'], '_status" class="cmb_upload_status">';
						if ( $meta != '' ) { 
							...
							if ( $check_image ) {
								...
								echo '<a href="#" class="cmb_remove_file_button" rel="', $field['id'], '">'.__('Remove Image','wp_horse').'</a>';
								echo '</div>';
							} else {
								$parts = explode( '/', $meta );
								...
								echo __('File','wp_horse').'<strong>', $title, '</strong>&nbsp;&nbsp;&nbsp; (<a href="', $meta, '" target="_blank" rel="external">Download</a> / <a href="#" class="cmb_remove_file_button" rel="', $field['id'], '">'.__('Remove File','wp_horse').'</a>)';
							}	
						}
					echo '</div>'; 
				break;
