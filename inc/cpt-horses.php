...
function create_horse_category_taxonomy() {
    ...
    register_taxonomy(
      ...
      array(
        'hierarchical' => true,
        'labels' => $labels,
        'query_var' => 'horse-category',
        'public' => true,
        'show_admin_column' => true,
        'show_in_nav_menus'=> false,
        'rewrite' => array(
          'slug' => __('horse-category','wp_horse'),
          'with_front' => false
          )
      )
    );
...
function create_horse_status_taxonomy() {
  $labels = array(
    ...
    'horse', array(
      'hierarchical' => false,
      'labels' => $labels,
      'query_var' => 'horse-status',
      'public' => true,
      'show_admin_column' => true,
      'show_in_nav_menus' => false,
      'rewrite' => array(
        'slug' => __('status','wp_horse'),
        'hierarchical' => false,
        'with_front' => false
       )
    )
...
function create_horse_genre_taxonomy() {
  $labels = array(
    ...
    'horse', array(
      'hierarchical' => false,
      'labels' => $labels,
      'query_var' => 'horse-gender',
      'public' => TRUE,
      'show_admin_column' => true,
      'show_in_nav_menus' => false,
      'rewrite' => array(
        'slug' => __('genre','wp_horse'),
        'hierarchical' => false,
        'with_front' => false
      )
    )
...
function create_horse_bloodline_taxonomy() {
  ...
  register_taxonomy(
    ...
    array(
      'hierarchical' => false,
      'labels' => $labels,
      'query_var' => 'horse-bloodline',
      'meta_box_cb' => false,
      'public' => true,
      'show_in_nav_menus' => false,
      'rewrite' => array(
        'slug' => __('bloodline','wp_horse'),
        'hierarchical' => false,
        'with_front' => false
      )
    )
...
function create_horse_breed_taxonomy() {
  $labels = array(
    ...
    array(
      'hierarchical' => false,
      'labels' => $labels,
      'query_var' => 'horse-breed',
      'public' => true,
      'show_in_nav_menus' => false,
      'rewrite' => array(
        'slug' => __('breed','wp_horse'),
        'hierarchical' => false,
        'with_front' => false
      )
    )
...
/*
create_horse_partners_taxonomy() {
  $labels = array(
    'name' => _x('Partners','wp_horse'),
    'menu_name' => __('Partners','wp_horse'),
    'add_new_item' => __('Add partner','wp_horse')
  );
  register_taxonomy(
    'horse-partners',
    'horse',
    array(
      'hierarchical' => false,
      'labels' => $labels,
      'query_var' => 'horse-partners',
      'public' => true,
      'show_in_nav_menus' => false,
      'rewrite' => array(
        'slug' => __('partners','wp_horse'),
        'hierarchical' => false,
        'with_front' => false
      )
    )
...
function create_horse_coat_taxonomy() {
  $labels = array(
    ...
    array(
      'hierarchical' => false,
      'labels' => $labels,
      'query_var' => 'horse-coat',
      'public' => true,
      'show_in_nav_menus' => false,
      'rewrite' => array(
        'slug' => __('coat','wp_horse'),
        'hierarchical' => false,
        'with_front' => false
      )
    )
...
function create_horse_pattern_taxonomy() {
  $labels = array(
    ...
    array(
      'hierarchical' => false,
      'labels' => $labels,
      'query_var' => 'horse-pattern',
      'public' => true,
      'show_in_nav_menus' => false,
      'rewrite' => array(
        'slug' => __('pattern','wp_horse'),
        'hierarchical' => false,
        'with_front' => false
      )
    )
...
function create_horse_color_taxonomy() {
  $labels = array(
    ...
    array(
      'hierarchical' => false,
      'labels' => $labels,
      'query_var' => 'horse-color',
      'public' => true,
      'show_in_nav_menus' => false,
      'rewrite' => array(
        'slug' => __('color','wp_horse'),
        'hierarchical' => false,
        'with_front' => false
      )
    )
...
function horsetype_permalink($permalink, $post_id, $leavename) {
  ...
  if (
    ...
    $taxonomy_slug = __('no-horse-category','wp_horse');
  }
